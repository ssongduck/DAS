...
{
    public partial class DA9110 : Form
    {
        private int iMul = 1;
        ...
        private void DA9100_Load(object sender, EventArgs e)
        {
            SetButtonBox();
        ...
        private void SetButtonBox()
        {
            ...
            buttonBox1.Font = new System.Drawing.Font(buttonBox1.Font.FontFamily, 18);
        ...
        private void DA9200_Activated(object sender, EventArgs e)
        {
            txtContent.Focus();
        }
    }
